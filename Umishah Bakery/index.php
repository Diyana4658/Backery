...
switch($_GET["action"]) {
	...
	case "add":
		if(!empty($_POST["quantity"])) {
			...
			$itemArray = array($productByCode["id"]=>array('name'=>$productByCode["name"], 'quantity'=>$_POST["quantity"], 'price'=>$productByCode["price"], 'image'=>$productByCode["image"]));
...
<?php		
    foreach ($_SESSION["cart_item"] as $item){
		...
		?>
				...
				<td style="text-align:center;"><a href="index.php?action=remove=<?php echo $item["code"]; ?>" class="btnRemoveAction"><img src="icon-delete.png" alt="Remove Item" /></a></td>
				</tr>
				<?php
